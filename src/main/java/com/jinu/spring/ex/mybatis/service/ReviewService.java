package com.jinu.spring.ex.mybatis.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import com.jinu.spring.ex.mybatis.domain.Review;
import com.jinu.spring.ex.mybatis.repository.ReviewRepository;
...
public class ReviewService {
	...
	public int addReview(int storeId 
			,String menu, String userName, double point, String review){
